...
template<typename T>
struct Baichuan2TritonModelInstance: AbstractTransformerModelInstance {

    Baichuan2TritonModelInstance(std::unique_ptr<ft::Baichuan2<T>>                           gpt,
...
private:
    ...
    const std::unique_ptr<ft::Baichuan2<T>>                           gpt_;
    const std::shared_ptr<ft::Baichuan2Weight<T>>                     gpt_weight_;
