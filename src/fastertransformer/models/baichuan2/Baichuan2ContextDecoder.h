...
template<typename T>
class Baichuan2ContextDecoder: public BaseLayer {
private:
    // meta data
    size_t head_num_;
...
public:
    Baichuan2ContextDecoder(size_t                              head_num,
    ...
    Baichuan2ContextDecoder(Baichuan2ContextDecoder<T> const& decoder);

    ~Baichuan2ContextDecoder();

    void forward(std::vector<Tensor>*                           output_tensors,
                 const std::vector<Tensor>*                     input_tensors,
                 const std::vector<Baichuan2DecoderLayerWeight<T>*>* decoder_layer_weights);
