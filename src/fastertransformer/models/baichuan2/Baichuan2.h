...
template<typename T>
class Baichuan2: public BaseLayer {
private:
    // meta data
    size_t head_num_;
    ...
    Baichuan2Decoder<T>*         gpt_decoder_;
    Baichuan2ContextDecoder<T>*  gpt_context_decoder_;
...
protected:
    ...
    // callback step
    size_t token_generated_cb_step_ = 5; // default 5, override by env BAICHUAN2_STREAM_CB_STEP
...
public:
    ...
    Baichuan2(Baichuan2<T> const& Baichuan2);
