...
template<typename T>
struct Baichuan2DecoderLayerWeight {
public:
    Baichuan2DecoderLayerWeight() = default;
    Baichuan2DecoderLayerWeight(const int int8_mode);
    Baichuan2DecoderLayerWeight(const int  hidden_units,
    ...
    Baichuan2DecoderLayerWeight(const Baichuan2DecoderLayerWeight& other);
    Baichuan2DecoderLayerWeight& operator=(const Baichuan2DecoderLayerWeight& other);
...
private:
    ...
    void setWeightPtr();
    void mallocWeights();
    void copyFrom(const Baichuan2DecoderLayerWeight& other);
};
