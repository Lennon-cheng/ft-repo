...
template<typename T>
struct Baichuan2Weight {

    Baichuan2Weight() = default;
    Baichuan2Weight(
    ...
    ~Baichuan2Weight();
    Baichuan2Weight(const Baichuan2Weight& other);
    Baichuan2Weight& operator=(const Baichuan2Weight& other);

    void loadModel(std::string dir_path);

    void resizeLayer(const int num_layer);

    std::vector<Baichuan2DecoderLayerWeight<T>*> decoder_layer_weights;
